...
pub(super) const KEYMAP_ACTIONS: &[KeymapActionDescriptor] = &[
    ...
    action("vim_normal", "Vim normal", "start_delete_operator", "Begin a delete operator and wait for a motion or text object."),
    action("vim_normal", "Vim normal", "start_yank_operator", "Begin a yank operator and wait for a motion or text object."),
    ...
    action("vim_operator", "Vim operator", "inner_text_object", "Begin an inner text object."),
    ...
    action("vim_text_object", "Vim text object", "word", "Word text object after an operator text-object prefix."),
...
pub(super) fn binding_slot<'a>(
    ...
    match (context, action) {
        ...
        ("vim_operator", "inner_text_object") => Some(&mut keymap.vim_operator.inner_text_object),
...
pub(super) fn bindings_for_action<'a>(
    ...
    match (context, action) {
        ...
        ("vim_operator", "inner_text_object") => Some(runtime_keymap.vim_operator.inner_text_object.as_slice()),
